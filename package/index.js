...
var KEY_PREFIX = 'yb_core_icon_storage';
var CACHE_TIME_PREFIX = 'caching_time';
var getDataTime = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    var value, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, AsyncStorage.getItem(CACHE_TIME_PREFIX + key)];
            case 1:
                value = _a.sent();
                return [2 /*return*/, value];
            case 2:
                error_3 = _a.sent();
                console.log("Cache Retrival Error:- ", error_3);
...
var removeData = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, AsyncStorage.removeItem(KEY_PREFIX + key)];
            case 1:
                _a.sent();
                return [4 /*yield*/, AsyncStorage.removeItem(CACHE_TIME_PREFIX + key)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
                error_4 = _a.sent();
                console.log("Cache Invalidation Error:- ", error_4);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
var useCacheInvalidate = function (timeToInvalidateCache) {
    require$$0.useEffect(function () {
        var inValidateCache = function () { return __awaiter(void 0, void 0, void 0, function () {
            var data, iconCachedData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, AsyncStorage.getAllKeys()];
                    case 1:
                        data = _a.sent();
                        iconCachedData = data.filter(function (item) { return item.startsWith(CACHE_TIME_PREFIX); });
                        iconCachedData.forEach(function (key) { return __awaiter(void 0, void 0, void 0, function () {
                            var plainKey, cacheRegisterTime, nowTime, cacheTime;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        plainKey = key.replace(CACHE_TIME_PREFIX, '');
                                        return [4 /*yield*/, getDataTime(plainKey)];
                                    case 1:
                                        cacheRegisterTime = _a.sent();
                                        nowTime = Date.now();
                                        cacheTime = Number(cacheRegisterTime);
                                        if (!(nowTime >= (cacheTime + timeToInvalidateCache * 86400000))) return [3 /*break*/, 3];
                                        console.log('Time to invalidate Cache. Removed Key:- ', key);
                                        return [4 /*yield*/, removeData(plainKey)];
                                    case 2:
                                        _a.sent();
                                        return [3 /*break*/, 3];
                                    case 3: return [2 /*return*/];
